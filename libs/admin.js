...
function resizeDiv()
{
	...
	document.getElementById('overflowDiv2').style.height = (iH < 300 ? 400 : iH) - getTop(document.getElementById('overflowDiv2')) + 'px';
	...
	document.getElementById('overflowDiv2').style.width = currentWidth + 'px';
